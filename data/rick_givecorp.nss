...
void main()
{
    ...
    // tunic
    CreateItemOnObject("daggerfordmil010", GetPCSpeaker(), 1);
    // helmet
    CreateItemOnObject("daggerfordmil002", GetPCSpeaker(), 1);
    // badge
    CreateItemOnObject("daggerfordmil018", GetPCSpeaker(), 1);
    // spear
    CreateItemOnObject("daggerfordmil017", GetPCSpeaker(), 1);
