...
/**** Begin ALFA Mod - Reduce to a max of +/- 5% to conform to ALFA guidelines.  ****/
...
//      SpeakString("PC " + IntToString(nPlayerSkillRank));
//      SpeakString("Adjust " + IntToString(nAdjust));
//      SpeakString("NPC " + IntToString(nNPCSkillRank));
