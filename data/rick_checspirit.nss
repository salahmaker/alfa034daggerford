...
int StartingConditional()
{
    ...
    if (GetItemPossessedBy(GetPCSpeaker(), "LathSpirit") != OBJECT_INVALID)
       return TRUE;

    if (GetItemPossessedBy(GetPCSpeaker(), "LessLathSpirit") != OBJECT_INVALID)
       return TRUE;

    if (GetItemPossessedBy(GetPCSpeaker(), "GreatLathSpirit") != OBJECT_INVALID)
       return TRUE;
