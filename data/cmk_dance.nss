...
void main()
{
    ...
    ActionPlayAnimation(ANIMATION_FIREFORGET_BOW, 1.0, 0.0);
    ActionPlayAnimation(ANIMATION_LOOPING_PAUSE_TIRED, 1.0, 1.0);
    ActionPlayAnimation(ANIMATION_FIREFORGET_VICTORY2, 1.0, 0.0);
