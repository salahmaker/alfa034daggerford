...
//Zelknolf's spell save DC and caster level fixes.
    ...
    SendMessageToAllDMs("In domination Gaze script");
    ...
    SendMessageToAllDMs("In the ay_domgaze script");
    ...
    if(!GetIsReactionTypeFriendly(oTarget))
    {
                ...
                (nRacial == RACIAL_TYPE_HUMANOID_REPTILIAN))
        {
           ...
           {
                //Make Will Save
                if (!/*Will Save*/ MySavingThrow(SAVING_THROW_WILL, oTarget, iSaveDC, SAVING_THROW_TYPE_MIND_SPELLS, OBJECT_SELF, 1.0))
                {
